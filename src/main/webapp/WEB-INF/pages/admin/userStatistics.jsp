    ...
    <div class="container col-xl-10 col-xxl-10 py-5">
        <div class="row g-lg-5 py-5">
            <div class="col-lg-3 text-center text-lg-start">
                <h2 class="display-4 fw-bold lh-1 mb-3">User statistics</h2>
                <p class="col-lg-11 fs-5">Просматривай статистику по всем пользователям. А кликая на заголовки таблицы, ты можешь ее сортировать</p>
            </div>
            ...
            <div class="col-md-10 mx-auto col-lg-9">
                <table class="table table-striped table-hover table_sort">
                    ...
                    <tr>
                        ...
                        <th scope="col">Пройденно всего</th>
                    ...
                    <c:forEach items="${statistics}" var="statistic" varStatus="loop">
                        <tr>
                            ...
                            <td>${statistic[2]}</td>
                            <td>${statistic[3]}</td>
                            <td>${statistic[4].equals("0") ? "" : statistic[4]}</td>
                            <td>${statistic[5]}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
